...
import '../sys_export_cli.dart';

class WindowsCLI implements SysExportCLI {
  ...
  void clearScreen() {
    ...
    FillConsoleOutputCharacter(outputHandle, ' '.codeUnitAt(0), consoleSize, 0, pCharsWritten);

    GetConsoleScreenBufferInfo(outputHandle, pBufferInfo);

    FillConsoleOutputAttribute(outputHandle, bufferInfo.wAttributes, consoleSize, 0, pCharsWritten);
